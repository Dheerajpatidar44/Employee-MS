...
const AdminDashboard = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 text-white">
            ...
            {/* Sidebar */}
            <div className={`fixed top-0 left-0 h-screen w-64 border-r border-border flex flex-col overflow-hidden shadow-[0_0_15px_rgba(99,102,241,0.15)] hover:shadow-[0_0_25px_rgba(99,102,241,0.4),0_0_45px_rgba(139,92,246,0.2)] transition-all duration-500 group z-40 transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
                } lg:translate-x-0`}>
                {/* Mobile Close Button */}
            ...
            <div className="lg:hidden fixed top-0 left-0 right-0 h-20 bg-gray-900/95 backdrop-blur-md border-b border-gray-700 z-20 flex items-center justify-between px-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs text-gray-400 hidden sm:inline">Management System</span>
                </div>

...
const Edit = () => {
  ...
  return (
    <div className="flex flex-col items-center py-10 px-4 text-white">
      <div className="w-full max-w-4xl">
        <h3 className="text-3xl font-semibold text-white inline-block pb-2 relative mb-8">
        ...
        <form onSubmit={handleSubmit} ref={dropdownRef} className="bg-gray-800/60 backdrop-blur-lg shadow-xl rounded-xl p-8 border border-gray-700">
          ...
          <div className="mt-8">
            ...
            >
              <span className="relative z-10">Update Employee</span>
